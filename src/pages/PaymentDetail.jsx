...
function PaymentDetail() {
  ...
  const [formData, setFormData] = useState({
    cari: "Tech Suppliers Ltd.",
    tarih: "2025-07-03",
    odemeSekli: "Havale",
    tutar: 2500.75,
    aciklama: "Açıklama notu buraya gelecek.",
  });
  ...
  const handleSave = () => {
    console.log("Ödeme Güncellendi:", formData);
    setEditMode(false);
    // Add API call here
  };
  ...
  const handleDelete = () => {
    ...
    if (confirmDelete) {
      console.log("Ödeme Silindi:", formData);
      // Add delete API call
    }
  };

  const fields = [
    { label: "Cari", name: "cari", type: "text" },
    { label: "Tarih", name: "tarih", type: "date" },
    { label: "Ödeme Şekli", name: "odemeSekli", type: "text" },
    { label: "Tutar (₺)", name: "tutar", type: "number" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="mt-10 flex justify-end gap-4">
          <Link to="/finans-yonetimi/odemeler">
            <motion.button
